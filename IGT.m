...
for i=1:40
        ...
        deck_A{i}(1) = raw_deck_A(i,1);
        deck_A{i}(2) = raw_deck_A(i,2);
        deck_A{i}(3) = raw_deck_A(i,3);
end

for i=1:40
    
        deck_B{i}(1) = raw_deck_B(i,1);
        deck_B{i}(2) = raw_deck_B(i,2);
        deck_B{i}(3) = raw_deck_B(i,3);
end

for i=1:40    
        deck_C{i}(1) = raw_deck_C(i,1);
        deck_C{i}(2) = raw_deck_C(i,2);
        deck_C{i}(3) = raw_deck_C(i,3);
end


for i=1:40
        deck_D{i}(1) = raw_deck_D(i,1);
        deck_D{i}(2) = raw_deck_D(i,2);
        deck_D{i}(3) = raw_deck_D(i,3);
end
...
str4 = double(sprintf('资金: %i元',cash));
str10 = double(sprintf('上轮资金: %i元',cash_previous));
...
str2 = double(sprintf('+%i元',reward));
str3 = double(sprintf(' -%i元',abs(punish)));
str4 = double(sprintf('资金: %i元',cash));
str5 = double(sprintf('%i / %i 卡片',trials,total_trials));
